                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$slider->key_point}}</td>
                            <td>{{$slider->title}}</td>
                            <td>{!!$slider->description!!}</td>
                            <td>
                                @if ($slider->status == 0)
                                <b class="text-danger">Inactive</b>
                                <a href="{{ route('active.slider', ['id' => $slider->id] )}}" class="btn btn-success btn-sm"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Mark Active">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </a>
                                @else
                                <b class="text-success">Active</b>
                                <a href="{{ route('deactive.slider', ['id' => $slider->id] )}}" class="btn btn-warning btn-sm"
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('edit.slider', ['id' => $slider->id] )}}" class="btn btn-warning"><i
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="key_point" class="form-control @error('key_point') is-invalid @enderror" placeholder="Enter Key Point" required>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Description" cols="30" rows="10" required></textarea>
                                <span class="text-danger">
                                    @error('description')
                                        <p class="text-danger">{{$message}}</p> 
                                    @enderror
